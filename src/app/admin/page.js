                            ...
                            <tbody>
                                {data.users.map(user => (
                                    <tr key={user._id} className="border-t">
                                        ...
                                        <td className="py-2">
                                            <span className={`px-2 py-1 text-xs font-semibold rounded-full ${user.isSuspended ? 'bg-yellow-200 text-yellow-800' : 'bg-green-200 text-green-800'}`}>
                                        ...
                                        <td className="py-2">
                                            {user.role !== 'admin' && (
                                                <button 
                                                    ...
                                                    className={`px-3 py-1 text-sm rounded-md text-white ${user.isSuspended ? 'bg-green-500 hover:bg-green-600' : 'bg-yellow-500 hover:bg-yellow-600'}`}
                                                >
